...
In this lab you will learn how to use the Node.js REPL (read-eval-print loop) to execute ad-hoc JavaScript statements. By the end you should be comfortable using the REPL and defining strings, objects, arrays, and functions in JavaScript.
